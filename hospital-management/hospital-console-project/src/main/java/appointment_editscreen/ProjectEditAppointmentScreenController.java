package appointment_editscreen;
...
public class ProjectEditAppointmentScreenController {
  ...
  public void Update(ActionEvent event) throws Exception {
    ...
    updateAppointment.setExamination_date(Examination_date.getText().toString());
    updateAppointment.setPatientName(PatientName.getText());
    updateAppointment.generateAppointmentId();
    updateAppointment.generatePatientId();
